...
phi = Expression('-rho*g*(zs - x[0])*-400*'+sigma_exp+'/(zs-zb)*slope',zb=zb,zs=zs,rho=rho,g=g,slope=slope)

# Load Interval mesh
mesh = IntervalMesh(dz,zs,zb) 
...
theta0 = Expression('T0',T0=surface_temp(0))
